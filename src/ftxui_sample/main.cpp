...
// configuration step. It creates a namespace called `cpp_tsl`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_tsl::cmake::project_name, cpp_tsl::cmake::project_version) };
